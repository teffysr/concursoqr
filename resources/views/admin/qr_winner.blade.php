                                        ...
                                        @foreach($qrWinner as $qr)
                                            <tr>
                                                <form class="row g-3 justify-content-center" method="POST" action="/admin/qr/update/{{ $qr->id }}">
                                                    ...
                                                    <td>
                                                        <input type="text" class="form-control @error('name') is-invalid @enderror" name="amount" value="{{ $qr->amount }}" id="amount" placeholder="1000">
                                                    </td>
                                                    <td>
                                                        <select class="form-select" aria-label="Default select example" name="available">
                                                            ...
                                                            <option value="0" {{ in_array( $qr->available,[false])?'selected':'' }}>Canjeado</option>
                                                        </select>
                                                    </td>
